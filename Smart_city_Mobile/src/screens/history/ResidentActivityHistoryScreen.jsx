...
export default function ResidentActivityHistoryScreen({ navigation }) {
  ...
  const renderPayment = ({ item }) => {
    const proofUri = item.proof_url
      ? `${API_BASE_URL}${item.proof_url}`
      : null;
...
const styles = StyleSheet.create({
  ...
  tab: { minWidth: 108, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 7, paddingVertical: 10, borderRadius: 9 },
  ...
  proofFrame: { borderWidth: 1, borderRadius: 12, overflow: 'hidden', marginTop: 13 },
  proofImage: { width: '100%', height: 190 },
  proofOverlay: { position: 'absolute', right: 8, bottom: 8, flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#000a', borderRadius: 8, paddingHorizontal: 9, paddingVertical: 6 },
  ...
  modalClose: { position: 'absolute', top: 48, right: 18, zIndex: 2, padding: 8 },
